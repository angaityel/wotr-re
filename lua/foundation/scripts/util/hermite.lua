...
function Hermite.calc_point(t, p0, p1, p2, p3)
	local t2 = t * t
	local t3 = t2 * t
	local two_t3 = t3 + t3
	local two_t2 = t2 + t2
...
function Hermite.calc_tangent(t, p0, p1, p2, p3)
	local t2 = t * t
	local dh1 = 6 * t2 - 6 * t
	local dh2 = 6 * t - 6 * t2
...
function Hermite.draw(segments, script_drawer, tangent_scale, color, p0, p1, p2, p3)
...
function Hermite.length(segments, p0, p1, p2, p3)
	local length = 0
	local last_point = p1
...
function Hermite.next_index(points, index)
...
function Hermite.spline_points(points, index)
