...
function RootCamera:parse_parameters(camera_settings, parent_node)
	...
	self._pitch_min = camera_settings.pitch_min and camera_settings.pitch_min * math.pi / 180
	self._pitch_max = camera_settings.pitch_max and camera_settings.pitch_max * math.pi / 180
	self._pitch_speed = camera_settings.pitch_speed and camera_settings.pitch_speed * math.pi / 180
	self._yaw_speed = camera_settings.yaw_speed and camera_settings.yaw_speed * math.pi / 180
	self._pitch_offset = camera_settings.pitch_offset and camera_settings.pitch_offset * math.pi / 180
...
function RootCamera:update(dt, data, pitch_speed, yaw_speed)
...
function RootCamera:update_pitch_yaw(dt, data, current_node)
	...
	local max_yaw_speed
	local look_vec = data.look_controller_input or Vector3(0, 0, 0)
