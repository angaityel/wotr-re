...
function BlendCamera:init(root_node)
...
function BlendCamera:parse_parameters(camera_settings, parent_node)
...
function BlendCamera:add_child_node(node)
...
function BlendCamera:update(dt, position, rotation, data)
